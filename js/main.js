...
function drawSpeedChart() {
  ...
  var options = {
    ...
    colors:['#005288'],
    pointShape: 'star',
    chartArea: {'backgroundColor':'#181c1f', left: '10%', top: '20%', width: '80%', height: '80%'},
    curveType: 'function',
...
function drawFuelChart() {
  ...
  var options = {
    ...
    chartArea: {'backgroundColor':'#181c1f', left: '10%', top: '20%', width: '80%', height: '80%'},
    backgroundColor: '#181c1f',
    legend: {position: 'top',textPosition: 'in', titleTextStyle: {color: '#FFFFFF'}, textStyle:{color:'#FFFFFF'}},
    fontSize: 16,
    fontName: 'Varela Round',
    hAxis: {title: 'Month',  titleTextStyle: {color: '#FFFFFF'}, textStyle:{color:'#FFFFFF'},textPosition: 'in'},
...
function drawOccupationChart() {
  ...
  var options = {
    title: 'Current occupation of Mars',
    height: '500px',
    titleTextStyle: {color: '#FFFFFF'},
